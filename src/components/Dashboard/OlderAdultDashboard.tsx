      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
          ...
          <p className="text-yellow-700 mb-4">
            Please subscribe to access your personalized care dashboard and connect with caregivers.
          </p>
          <Link
            to="/subscribe"
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {carePlan ? (
            <div className="space-y-3">
              <div className="text-sm text-gray-600">
                ...
                <p className="text-gray-900">{new Date(carePlan.next_appointment).toLocaleDateString()}</p>
              </div>
              <div className="text-sm text-gray-600">
                <span className="font-medium">Current goals:</span>
                <p className="text-gray-900">{carePlan.current_goals || 'Maintain wellness'}</p>
              </div>
              <Link
                to="/care-plan"
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Today's Journal</h3>
          ...
          {todayJournal ? (
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">{todayJournal.pain_level}/10</span>
              </div>
              <div className="flex justify-between text-sm">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">My Caregiver</h3>
